...
class RDTRunner(
    ...
    def __init__(self, *, action_dim, pred_horizon, config, 
        ...
        # 实际上分了三个条件输入 语言 图像 状态
        # adater就是用mlp把所有的东西变成统一维度的，也许有意义的向量
    ...
    def build_condition_adapter(
        ...
        if projector_type == 'linear':
            ...
            if mlp_gelu_match:
                ...
                for _ in range(1, mlp_depth):# 根据mlp深度来添加层,不断堆叠gelu和输出的linear 
    ...
    def compute_loss(self, lang_tokens, lang_attn_mask, img_tokens, 
        ...
        # Predict the denoised result rdt的模型输入还是需要经过mlp的adaptor
